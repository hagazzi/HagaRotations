...
[Rotation("HagaAST", CombatType.PvE, GameVersion = "7.0")]
[SourceCode(Path = "main/DefaultRotations/Healer/AST_Default.cs")]
[Api(2)]
public sealed class HagaAST : AstrologianRotation
{
    ...
    protected override bool GeneralGCD(out IAction? act)
    {
        ...
        ////Umbral Draw
        //if ((AstralDrawPvE.AdjustedID == 37018) && (AstralDrawPvE.CanUse(out act))) return true;

        ////Astral Draw
        //if ((AstralDrawPvE.AdjustedID == 37017) && (AstralDrawPvE.CanUse(out act))) return true;
